...
public class FileUtil {
    ...
    public static void saveToFile(UserProfile profile, String workoutPlanRaw) throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_PATH, true))) {
            ...
            writer.write("BMI     : " + String.format("%.1f", profile.getBmi()) + " (" + profile.getBMICategory() + ")"); writer.newLine();
    ...
    public static void readByName(String targetName) throws IOException {
        ...
        if (matches.isEmpty()) {
            System.out.println(Ansi.YELLOW + "  No records found for: " + Ansi.BRIGHT_YELLOW + targetName + Ansi.RESET);
            return;
        }
        System.out.println(Ansi.BOLD + Ansi.BRIGHT_CYAN + "\n  Found " + matches.size() + " record(s) for: " + Ansi.BRIGHT_WHITE + targetName + Ansi.RESET);
    ...
    private static void printDecoratedRecord(List<String> rec) {
        ...
        for (String line : rec) {
            ...
            if (line.startsWith("====")) {
                ...
                String dc = (day.equals("Saturday") || day.equals("Sunday")) ? Ansi.BRIGHT_MAGENTA : Ansi.BRIGHT_YELLOW;
