...
public class HolisticHealthSystem {
    ...
    static MentalStatus runMentalQuiz() {
        ...
        String[][] questions = {
            ...
            },
            {
                ...
                "A.  Exhausted even without doing anything",
                "B.  I get tired easily and feel drained",
                "C.  My energy is mostly fine"
            },
            {
                "Q3. How well are you sleeping?",
                "A.  Sleep too much or barely at all",
                "B.  Trouble falling or staying asleep",
                "C.  Sleep well most nights"
            },
            {
                "Q4. How do you handle daily tasks or responsibilities?",
                "A.  Can barely do anything — feel hopeless",
                "B.  Overwhelmed and struggling to keep up",
                "C.  Manage them without major issues"
            },
            {
                "Q5. How often do you feel anxious, tense, or on edge?",
                "A.  Constantly — hard to calm down",
                "B.  Often, especially under pressure",
                "C.  Only occasionally and it passes quickly"
            },
            {
                "Q6. How is your appetite lately?",
                "A.  I have almost no appetite or I overeat compulsively",
                "B.  My appetite is inconsistent / affected by stress",
                "C.  I eat normally with no major issues"
            },
            {
                "Q7. How often do you feel motivated to do things you used to enjoy?",
                "A.  Almost never — nothing feels worth doing",
                "B.  Motivation is low — I push myself to do things",
                "C.  I still enjoy and look forward to activities"
            },
            {
                "Q8. How would you describe your ability to concentrate or focus?",
                "A.  Very hard to focus — my mind feels foggy",
                "B.  Distracted often but can manage with effort",
                "C.  I concentrate well without much difficulty"
            },
            {
                "Q9. How do you feel about your social connections?",
                "A.  I avoid people and feel very isolated",
                "B.  I feel somewhat disconnected or withdrawn",
                "C.  I feel connected and supported by others"
            }
        };
        ...
        for (int qi = 0; qi < questions.length; qi++) {
            ...
            while (true) {
                ...
                if (answer.equals("A") || answer.equals("B") || answer.equals("C")) {
                    ...
                    System.out.println();
                    System.out.println(Ansi.BOLD + Ansi.BG_RED + Ansi.WHITE
                            + "  ✘  INVALID INPUT  " + Ansi.RESET
                            + " " + Ansi.BRIGHT_RED
                            + "\"" + answer + "\" is not accepted. Please type only A, B, or C."
                            + Ansi.RESET);
        ...
        if (totalScore >= 11) {
            ...
            System.out.println(Ansi.YELLOW
                    + "  ║  You seem to be under noticeable stress.\n"
            ...
            try {
                ...
                if (names.isEmpty()) {
                    ...
                    System.out.println(Ansi.BRIGHT_CYAN
                            + "  ║                                              ║" + Ansi.RESET);
                    System.out.println(Ansi.YELLOW
                            + "  ║   📭  No saved records found yet.            ║" + Ansi.RESET);
                    System.out.println(Ansi.BRIGHT_CYAN
                            + "  ║                                              ║" + Ansi.RESET);
                    System.out.println(Ansi.BOLD + Ansi.BRIGHT_CYAN
                            + "  ╠══════════════════════════════════════════════╣" + Ansi.RESET);
                ...
                System.out.println(Ansi.BOLD + Ansi.CYAN
                        + "  ║  " + Ansi.BRIGHT_WHITE + "A." + Ansi.WHITE
                ...
                System.out.println(Ansi.BOLD + Ansi.BRIGHT_CYAN
                        + "  ╚══════════════════════════════════════════════╝" + Ansi.RESET);
                System.out.print(Ansi.BOLD + Ansi.YELLOW
                        + "\n  ▶  Enter choice (0 = Back, A = All, 1-" + names.size() + " = Person): "
                        + Ansi.RESET);
    ...
    static void pressEnterToContinue() {
        ...
        System.out.println(Ansi.BOLD + Ansi.BRIGHT_CYAN
                + "  ╔══════════════════════════════════════════════╗" + Ansi.RESET);
        System.out.println(Ansi.BOLD + Ansi.BRIGHT_WHITE
                + "  ║   ↵  Press ENTER to return to Records Menu   ║" + Ansi.RESET);
        System.out.println(Ansi.BOLD + Ansi.BRIGHT_CYAN
                + "  ╚══════════════════════════════════════════════╝" + Ansi.RESET);
        scanner.nextLine();
    }
